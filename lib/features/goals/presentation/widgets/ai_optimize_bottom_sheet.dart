...
class _ContentSection extends StatelessWidget {
  ...
  final OptimizeGoalResponse result;
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _OptimizedTitleField(titleController: titleController),
        const SizedBox(height: AppSpacing.xl),
        _ExplanationSection(explanation: result.explanation),
        const SizedBox(height: AppSpacing.xl),
        _SubGoalsSection(subGoals: result.subGoals),
        const SizedBox(height: AppSpacing.xl),
      ],
    );
  }
...
class _OptimizedTitleField extends StatelessWidget {
  const _OptimizedTitleField({required this.titleController});
...
class _SubGoalsSection extends StatelessWidget {
  const _SubGoalsSection({required this.subGoals});
...
class _SubGoalItem extends StatelessWidget {
  const _SubGoalItem({
    required this.index,
...
class _ActionButtonsSection extends StatelessWidget {
  const _ActionButtonsSection({
    required this.optimizedAsync,
    required this.titleController,
    required this.onApply,
  });

  final AsyncValue<OptimizeGoalResponse?> optimizedAsync;
  final TextEditingController titleController;
  final void Function(OptimizeGoalResponse) onApply;
    ...
    return Container(
      ...
      child: optimizedAsync.when(
        data: (result) {
          ...
          final editedTitle = titleController.text.trim().isEmpty
